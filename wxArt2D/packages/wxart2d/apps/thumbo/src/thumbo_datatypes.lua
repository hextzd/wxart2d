-- ---------------------------------------------------------------------------
-- C:/Users/db348/art2d/trunk/wxArt2D/packages/wxart2d/apps/thumbo/src/thumbo_datatypes.lua was generated by genwxbind.lua 
-- 
...
thumbo_dataTypeTable =
{
  ...
  ThumboLuaProcCommandProcessor = {
    ...
    IsNumber = false,
    Name = "ThumboLuaProcCommandProcessor",
    ValueType = "class",
  },
  ToolDlg = {
    BaseClasses = {
...
-- Cache the dataTypes
-- ---------------------------------------------------------------------------
    for k, v in pairs(thumbo_typedefTable) do
        typedefTable[k] = v
    end
    for k, v in pairs(thumbo_dataTypeTable) do
        dataTypeTable[k] = v
    end
    for k, v in pairs(thumbo_preprocConditionTable) do
