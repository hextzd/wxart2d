...
propid = canobjAddScript2:HasPropertyId( "maxX" );
if propid == nil then
    propid_maxX = wx.a2dPropertyIdDouble( "maxX", 0, wx.a2dPropertyId.flag_userDefined )
    canobjAddScript2:AddPropertyId( propid_maxX );
end
propid = canobjAddScript2:HasPropertyId( "maxY" );
if propid == nil then
    propid_maxY = wx.a2dPropertyIdDouble( "maxY", 0, wx.a2dPropertyId.flag_userDefined )
    canobjAddScript2:AddPropertyId( propid_maxY );
end
propid = canobjAddScript2:HasPropertyId( "aUint32" );
if propid == nil then
    propid3 = wx.a2dPropertyIdUint32( "aUint32", 10, wx.a2dPropertyId.flag_userDefined )
    canobjAddScript2:AddPropertyId( propid3 );
end
propid = canobjAddScript2:HasPropertyId( "aInt32" );
if propid == nil then
    propid4 = wx.a2dPropertyIdInt32( "aInt32", 10, wx.a2dPropertyId.flag_userDefined )
    canobjAddScript2:AddPropertyId( propid4 );
end
propid = canobjAddScript2:HasPropertyId( "aString" );
if propid == nil then
    propid5 = wx.a2dPropertyIdString( "aString", "propstring", wx.a2dPropertyId.flag_userDefined )
    canobjAddScript2:AddPropertyId( propid5 );
end
propid = canobjAddScript2:HasPropertyId( "Colour" );
if propid == nil then
    propid_Colour = wx.a2dPropertyIdColour( "Colour", wx.wxColour( 0, 255, 255 ), wx.a2dPropertyId.flag_userDefined )
    canobjAddScript2:AddPropertyId( propid_Colour );
end
