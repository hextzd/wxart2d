...
class wxDrawingConnector: public a2dFrameViewConnector
{
...
public:
    ...
    a2dObject* SmrtPtrOwn();
    bool SmrtPtrRelease();

    a2dCanvasThumboEditorFrame* m_lastMadeEditorFrame;

    a2dCanvasThumboEditorFrame* m_currentActiveEditorFrame;
