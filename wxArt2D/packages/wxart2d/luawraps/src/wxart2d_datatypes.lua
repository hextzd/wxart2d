-- ---------------------------------------------------------------------------
-- C:/soft/art2d/wxArt2D/packages/wxart2d/luawraps/src/wxart2d_datatypes.lua was generated by genwxbind.lua 
-- 
...
-- Cache the dataTypes
-- ---------------------------------------------------------------------------
    for k, v in pairs(wxart2d_typedefTable) do
        typedefTable[k] = v
    end
    for k, v in pairs(wxart2d_dataTypeTable) do
        dataTypeTable[k] = v
    end
    for k, v in pairs(wxart2d_preprocConditionTable) do
