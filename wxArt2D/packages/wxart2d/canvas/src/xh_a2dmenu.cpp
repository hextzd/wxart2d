...
IMPLEMENT_DYNAMIC_CLASS( a2dMenuXmlHandler, wxMenuXmlHandler )

a2dMenuXmlHandler::a2dMenuXmlHandler() :
    wxMenuXmlHandler()
{
}

wxObject* a2dMenuXmlHandler::DoCreateResource()
{
...
#endif
        if ( a2dMenuBarXmlHandler::m_parentFrame )
        {
            a2dDrawingEditor* parentFrame = wxDynamicCast( a2dMenuBarXmlHandler::m_parentFrame, a2dDrawingEditor );
            if ( parentFrame )
...
bool a2dMenuXmlHandler::CanHandle( wxXmlNode* node )
{
...
IMPLEMENT_DYNAMIC_CLASS( a2dMenuBarXmlHandler, wxMenuBarXmlHandler )

wxFrame* a2dMenuBarXmlHandler::m_parentFrame = NULL;

a2dMenuBarXmlHandler::a2dMenuBarXmlHandler() : wxMenuBarXmlHandler()
{
}

wxObject* a2dMenuBarXmlHandler::DoCreateResource()
{
...
bool a2dMenuBarXmlHandler::CanHandle( wxXmlNode* node )
{
...
IMPLEMENT_DYNAMIC_CLASS( a2dToolBarXmlHandler, wxToolBarXmlHandler )

a2dToolBarXmlHandler::a2dToolBarXmlHandler()
    : wxToolBarXmlHandler(), m_isInside( false ), m_toolbar( NULL )
{
}

wxObject* a2dToolBarXmlHandler::DoCreateResource()
{
    if ( m_class == wxT( "a2dToolCmd" ) )
    {
        ...
        if ( a2dToolBarXmlHandler::m_parentAsWindow )
        {
            a2dDrawingEditor* parentFrame = wxDynamicCast( a2dMenuBarXmlHandler::m_parentFrame, a2dDrawingEditor );
            if ( parentFrame )
    ...
    else if ( m_class == wxT( "a2dToolBar" ) )
    {
        ...
        return a2dToolBarXmlHandler::DoCreateResource();

}

bool a2dToolBarXmlHandler::CanHandle( wxXmlNode* node )
{
