...
#
#  wxWidgets_RELEASE        - version of wxWidgets that was found
...
macro( wx_find_root )
    ...
    set( wxWidgets_ROOT_DIR ${s_wxWidgets_ROOT_DIR} CACHE PATH "wxWidgets base/installation directory"  FORCE )                      
...
macro(wx_config_set_in_options)
    ...
    if( DEFINED wxWidgets_IN_USE_DEBUG )
        set( wxWidgets_USE_DEBUG ${wxWidgets_IN_USE_DEBUG} )
    endif()

    if ( DEFINED wxWidgets_IN_USE_UNICODE )
        set( wxWidgets_USE_UNICODE ${wxWidgets_IN_USE_UNICODE} )
    endif()        

    if( DEFINED wxWidgets_IN_USE_STATIC )
        set( wxWidgets_USE_STATIC ${wxWidgets_IN_USE_STATIC} )
    endif()

    if( DEFINED wxWidgets_IN_USE_UNIVERSAL )
        set( wxWidgets_USE_UNIVERSAL ${wxWidgets_IN_USE_UNIVERSAL} )
    endif()

    if( DEFINED wxWidgets_IN_USE_MONOLITHIC )
        set( wxWidgets_USE_MONOLITHIC ${wxWidgets_IN_USE_MONOLITHIC} )
    endif()

    if( DEFINED wxWidgets_IN_RELEASE )
        set( wxWidgets_RELEASE ${wxWidgets_IN_RELEASE} )
    endif()

    if( DEFINED wxWidgets_IN_PORT )
        set( wxWidgets_PORT ${wxWidgets_IN_PORT} )    
    endif()
    
    option( wxWidgets_USE_DEBUG  "Use Debug versions of wxWidgets libraries" ${wxWidgets_USE_DEBUG} )
    option( wxWidgets_USE_UNICODE "Use Unicode versions of wxWidgets libraries" ${wxWidgets_USE_UNICODE} )
    option( wxWidgets_USE_STATIC "Use static versions (.a) of wxWidgets libraries" ${wxWidgets_USE_STATIC} )
    option( wxWidgets_USE_UNIVERSAL "Use Universal versions (.so) of wxWidgets libraries" ${wxWidgets_USE_UNIVERSAL} )
    option( wxWidgets_USE_MONOLITHIC "Use wxWidgets build as monolithic library" ${wxWidgets_USE_MONOLITHIC} )
    set( wxWidgets_RELEASE ${wxWidgets_RELEASE} CACHE STRING "Set wxWidgets version"  FORCE )
    set( wxWidgets_PORT ${wxWidgets_PORT} CACHE STRING "Set wxWidgets configuration port"  FORCE )    
...
macro( wx_find_defaultconfig p_wxRootDir )
    if( NOT ${p_wxRootDir} STREQUAL "" )
        ...
        if( ${wxWidgets_FIND_STYLE} STREQUAL "WIN32_STYLE_FIND" )
            ...
            set( wxWidgets_PORT "msw" )
            if( EXISTS ${l_wxLibDir}/mswunivud )
                set( wxWidgets_SELECTED_CONFIG mswunivud )
                set( wxWidgets_USE_UNIVERSAL ON )
                set( wxWidgets_USE_UNICODE ON )
                set( wxWidgets_USE_DEBUG ON )
            elseif( EXISTS ${l_wxLibDir}/mswunivd )
                set( wxWidgets_SELECTED_CONFIG mswunivd )
                set( wxWidgets_USE_UNIVERSAL ON )
                set( wxWidgets_USE_UNICODE OFF )
                set( wxWidgets_USE_DEBUG ON )
            elseif( EXISTS ${l_wxLibDir}/mswud )
                set( wxWidgets_SELECTED_CONFIG mswud )
                set( wxWidgets_USE_UNIVERSAL OFF )
                set( wxWidgets_USE_UNICODE ON )
                set( wxWidgets_USE_DEBUG ON )
            elseif( EXISTS ${l_wxLibDir}/mswd )
                set( wxWidgets_SELECTED_CONFIG mswd )
                set( wxWidgets_USE_UNIVERSAL OFF )
                set( wxWidgets_USE_UNICODE OFF )
                set( wxWidgets_USE_DEBUG ON )
            elseif( EXISTS ${l_wxLibDir}/mswunivu )
                set( wxWidgets_SELECTED_CONFIG mswunivu )
                set( wxWidgets_USE_UNIVERSAL ON )
                set( wxWidgets_USE_UNICODE ON )
                set( wxWidgets_USE_DEBUG OFF )
            elseif( EXISTS ${l_wxLibDir}/mswuniv )
                set( wxWidgets_SELECTED_CONFIG mswuniv )
                set( wxWidgets_USE_UNIVERSAL ON )
                set( wxWidgets_USE_UNICODE OFF )
                set( wxWidgets_USE_DEBUG OFF )
            elseif( EXISTS ${l_wxLibDir}/mswu )
                set( wxWidgets_SELECTED_CONFIG mswu )
                set( wxWidgets_USE_UNIVERSAL OFF )
                set( wxWidgets_USE_UNICODE ON )
                set( wxWidgets_USE_DEBUG OFF )
            elseif( EXISTS ${l_wxLibDir}/msw )
                set( wxWidgets_SELECTED_CONFIG msw )
                set( wxWidgets_USE_UNIVERSAL OFF )
                set( wxWidgets_USE_UNICODE OFF )
                set( wxWidgets_USE_DEBUG OFF )
            else()
                set( wxWidgets_SELECTED_CONFIG )
                if ( wxWidgets_FIND_REQUIRED )
                    ERROR_MSG( FATAL_ERROR "no default configuration found in: ${p_wxRootDir}")                                
                endif()    
            endif()

            if (EXISTS "${p_wxRootDir}/include/wx/version.h")
                # For MSW use version.h
                FILE(STRINGS "${p_wxRootDir}/include/wx/version.h" wxWidgets_MAJOR_VERSION  REGEX "#define wxMAJOR_VERSION[^0-9]*([0-9]+)")
                FILE(STRINGS "${p_wxRootDir}/include/wx/version.h" wxWidgets_MINOR_VERSION  REGEX "#define wxMINOR_VERSION[^0-9]*([0-9]+)")
                FILE(STRINGS "${p_wxRootDir}/include/wx/version.h" wxWidgets_RELEASE_NUMBER REGEX "#define wxRELEASE_NUMBER[^0-9]*([0-9]+)")
            ...
            set(wxWidgets_RELEASE "${wxWidgets_RELEASE_NODOT}"  )                   
            ...
            if( NOT ${wxWidgets_SELECTED_CONFIG} STREQUAL "" )               
            ...
            mark_as_advanced( FORCE wxWidgets_SELECTED_CONFIG )
        endif()
            ...
            if( _wx_result EQUAL 0)
                ...
                foreach(_opt_name debug static unicode universal)
                    ...
                    if( wxWidgets_SELECTED_CONFIG MATCHES ".*${_opt_name}.*")
                        set(wxWidgets_USE_${_upper_opt_name} ON )
                    else()
                        set(wxWidgets_USE_${_upper_opt_name} OFF )
                    endif()
                ...
                # string( REGEX MATCH "([0-9].[0-9]).[0-9]*" wxWidgets_RELEASE "${wxWidgets_SELECTED_CONFIG}" )
                string( REGEX MATCH "([0-9].[0-9]).*" wxWidgets_RELEASE "${wxWidgets_SELECTED_CONFIG}" )
...
option( wxWidgets_VERBOSE "Set wxWidgets verbose find" ON )
...
if ( ${CMAKE_GENERATOR} STREQUAL "Unix Makefiles" )
    ...
    if( wxWidgets_USE_MONOLITHIC )
        set(wxWidgets_FIND_COMPONENTS ${wxWidgets_FIND_COMPONENTS} )
    else()
        set(wxWidgets_FIND_COMPONENTS ${wxWidgets_FIND_COMPONENTS} aui qa xrc html adv xml net core base )
    endif()
    set( s_wxCompiler "gcc" )
...
if( ${wxWidgets_FIND_STYLE} STREQUAL "WIN32_STYLE_FIND" )
    ...
    if ( NOT DEFINED wxWidgets_DEFAULT_SELECTED_CONFIG )
        ...
        set( wxWidgets_DEFAULT_SELECTED_CONFIG ${wxWidgets_SELECTED_CONFIG} CACHE INTERNAL "" FORCE )
    endif()
    ...
    # global settings for std wx libs
    ...
    macro(WX_FIND_LIBS p_unv p_ucd p_dbg)
        ...
        foreach(LIB png tiff jpeg zlib regex expat)
            ...
            if ( wxWidgets_VERBOSE )
                message( STATUS "detected as: ${s_libPre}wx${LIB}${p_ucd}${p_dbg} = ${WX_${LIB}${p_dbg}}")
            endif()    
        endforeach(LIB)
        ...
        find_library(WX_base${p_dbg}
            NAMES
            ${s_libPre}wxbase${wxWidgets_RELEASE_NODOT}${p_ucd}${p_dbg}
            PATHS ${s_wxLibDir}
            NO_DEFAULT_PATH
        )
        ...
        foreach(LIB net odbc xml )
            ...
            find_library(WX_${LIB}${p_dbg}
                NAMES
                ${s_libPre}wxbase${wxWidgets_RELEASE_NODOT}${p_ucd}${p_dbg}_${LIB}
                PATHS ${s_wxLibDir}
                NO_DEFAULT_PATH
            )
            get_filename_component( WX_${LIB}${p_dbg} ${WX_${LIB}${p_dbg}} NAME_WE )
            ...
            mark_as_advanced(WX_${LIB}${p_dbg})
            if ( wxWidgets_VERBOSE )
                message( STATUS "detected as: wxbase${wxWidgets_RELEASE_NODOT}${p_ucd}${p_dbg}_${LIB} = ${WX_${LIB}${p_dbg}}")
            endif()    
        endforeach(LIB)
        ...
        find_library( WX_mono${p_dbg}
            NAMES
            ${s_libPre}wxmsw${p_unv}${wxWidgets_RELEASE_NODOT}${p_ucd}${p_dbg}
            PATHS ${s_wxLibDir}
            NO_DEFAULT_PATH
        )
        ...
        foreach( LIB core adv aui html media xrc dbgrid gl qa stc richtext gizmos things netutils gizmos_xrc )
            ...
            find_library(WX_${LIB}${p_dbg}
                NAMES
                ${s_libPre}wxmsw${p_unv}${wxWidgets_RELEASE_NODOT}${p_ucd}${p_dbg}_${LIB}
                PATHS ${s_wxLibDir}
                NO_DEFAULT_PATH
            )
            get_filename_component( WX_${LIB}${p_dbg} ${WX_${LIB}${p_dbg}} NAME_WE )
            ...
            mark_as_advanced(WX_${LIB}${p_dbg})
            if ( wxWidgets_VERBOSE )
                message( STATUS "detected as: wxmsw${p_unv}${wxWidgets_RELEASE_NODOT}${p_ucd}${p_dbg}_${LIB} = ${WX_${LIB}${p_dbg}}")
            endif()    
        endforeach(LIB)

        #foreach( LIB gl ) the gl lib is now wxmsw28ud_gl.lib, so added above here, and removed here
        foreach( LIB scintilla )
            set( WX_${LIB}${p_dbg} "WX_${LIB}${p_dbg}-NOTFOUND" CACHE FILEPATH "Cleared." FORCE)
            find_library(WX_${LIB}${p_dbg}
                NAMES
                ${s_libPre}wx${LIB}${p_dbg}
            ...
            mark_as_advanced(WX_${LIB}${p_dbg})
            if ( wxWidgets_VERBOSE )
                message( STATUS "detected wx${LIB}${p_dbg} = ${WX_${LIB}${p_dbg}}")
            endif()    
        endforeach(LIB)
    ...
    if(s_wxRootDir)   
        ...
        #    set( wxWidgets_RELEASE_NODOT "${wxWidgets_WXVER_MAJOR}${wxWidgets_WXVER_MINOR}" )
        ...
        if (wxWidgets_PFVERSION MATCHES "[0-2].[0-8].*" )
            ...
            if ( NOT ${has-stc} EQUAL -1 )
                set(wxWidgets_FIND_COMPONENTS ${wxWidgets_FIND_COMPONENTS} scintilla )
            endif()      
        endif()   
...
if( ${wxWidgets_FIND_STYLE} STREQUAL "UNIX_STYLE_FIND" )
    ...
    macro(WX_CONFIG_SELECT_SET_OPTIONS)
      ...
      list( APPEND wxWidgets_SELECT_OPTIONS --version=${wxWidgets_RELEASE} )
    ...
    if(wxWidgets_CONFIG_EXECUTABLE)
        ...
        if ( wxWidgets_WANTED_AVAILABLE EQUAL 0 )
            ...
            if( RET EQUAL 0 )
                ...
                # drop -D* from CXXFLAGS but not -otherflags
...
if (wxWidgets_FOUND)
    if(NOT wxWidgets_FIND_QUIETLY)
        ...
        MESSAGE( STATUS "wxWidgets_RELEASE       : ${wxWidgets_RELEASE}" )
