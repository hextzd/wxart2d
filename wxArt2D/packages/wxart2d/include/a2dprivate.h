/*! \file include/a2dprivate.h
    ...
    RCS-ID: $Id: a2dprivate.h,v 1.8 2009/09/01 21:13:56 titato Exp $
*/

#include "wx/wx.h"

// our setup file which contains all wxART2D_USE_XXXXX variables.
#include "art2dsetup.h"
