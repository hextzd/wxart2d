...
typedef std::list<int> kbGraphNumList;
...
public:
    ...
    kbGraph( kbBool_Engine* GC );
    kbGraph( kbLink*, kbBool_Engine* GC );
    ...
    kbLink* AddLink( kbNode *begin, kbNode *end );
    ...
    void WriteKEY( kbBool_Engine* GC,  FILE* file = NULL );
    void WriteGraphKEY( kbBool_Engine* GC, const string& filename );
...
protected:
    ...
    */
    ...
    kbGraph* CollectGraphNumber( int graphnumber, kbGraphNumList& todo );
    ...
    /*
       ...
       \return true if found a hole
    */
    bool CollectGraph( kbNode *current_node, BOOL_OP operation, bool detecthole, int graphnumber );
    ...
    /*
       ...
       \return true if found a hole
    */
    bool CollectGraphLast( kbNode *current_node, BOOL_OP operation, bool detecthole, int graphnumber );
