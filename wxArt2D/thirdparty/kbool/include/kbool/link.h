...
public:
    ...
    //! contructors
    kbLink( kbBool_Engine* GC );

    //! contructors
    kbLink( int graphnr, kbNode* begin, kbNode* end, kbBool_Engine* GC );

    //! contructors
    kbLink( kbNode *begin, kbNode *end, kbBool_Engine* GC );
    ...
    void SetArcPiece( bool arcPiece );
    ...
    void  AddLineCrossing( B_INT , B_INT , kbLink* );
...
GroupType m_group : 1;
    ...
    //! belonged to an arc in the original polygon
    bool m_arcPiece: 1; 
