...
public:
    ...
    kbNode( kbBool_Engine* GC );

    kbNode( const B_INT, const B_INT, kbBool_Engine* GC );

    kbNode( kbLPoint* const a_point, kbBool_Engine* GC );
    kbNode( kbNode * const, kbBool_Engine* GC );
    ...
    */
    ...
    kbLink* GetHoleFlaggedLink( bool checkbin = false );
